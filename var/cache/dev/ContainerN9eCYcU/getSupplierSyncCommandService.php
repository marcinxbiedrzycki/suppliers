...
class getSupplierSyncCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Supplier/Factory/SupplierFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Supplier/Factory/SupplierFactory.php';
        include_once \dirname(__DIR__, 4).'/src/Parser/Factory/ParserFactoryInterface.php';
        include_once \dirname(__DIR__, 4).'/src/Parser/Factory/ParserFactory.php';
