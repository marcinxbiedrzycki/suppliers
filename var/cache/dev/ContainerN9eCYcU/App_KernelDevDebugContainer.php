...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('products.get', [0 => function () {
            return ($this->privates['App\\Listener\\ProductsListener'] ?? $this->load('getProductsListenerService'));
        }, 1 => 'logProducts'], 0);
        $instance->addListener('App\\Event\\GetProductsEvent', [0 => function () {
            return ($this->privates['App\\Listener\\ProductsListener'] ?? $this->load('getProductsListenerService'));
        }, 1 => 'logProducts'], 0);
    ...
    protected function getRouterService()
    {
        ...
        $a->pushHandler(($this->privates['monolog.handler.suppliers_logger'] ?? $this->getMonolog_Handler_SuppliersLoggerService()));
    ...
    /**
     * Gets the private 'monolog.handler.suppliers_logger' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected function getMonolog_Handler_SuppliersLoggerService()
    {
        $this->privates['monolog.handler.suppliers_logger'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/log/supplier.log'), 200, true, NULL, false);
    ...
    protected function getMonolog_Logger_RequestService()
    {
        ...
        $instance->pushHandler(($this->privates['monolog.handler.suppliers_logger'] ?? $this->getMonolog_Handler_SuppliersLoggerService()));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'monolog.handlers_to_channels' => [
                'monolog.handler.suppliers_logger' => NULL,
